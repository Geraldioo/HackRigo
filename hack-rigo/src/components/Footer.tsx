            ...
            <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
              ...
              <div className="mt-4">
                <span className="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                  <a href="https://www.facebook.com/erigostoreapparel" className="text-gray-500 cursor-pointer hover:text-gray-700">
                    <svg
                      fill="currentColor"
                      strokeLinecap="round"
                  ...
                  <a href="https://twitter.com/erigostore" className="ml-3 text-gray-500 cursor-pointer hover:text-gray-700">
                    <svg
                      fill="currentColor"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                  ...
                  <a href="https://www.instagram.com/erigostore" className="ml-3 text-gray-500 cursor-pointer hover:text-gray-700">
                    <svg
                      fill="none"
                      stroke="currentColor"
                      strokeLinecap="round"
